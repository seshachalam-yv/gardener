...
// nodeReadinessRuleCRDYAML is the CRD for NodeReadinessRule from upstream NRC v0.3.0.
// Source: https://github.com/kubernetes-sigs/node-readiness-controller/blob/v0.3.0/config/crd/bases/readiness.node.x-k8s.io_nodereadinessrules.yaml
var nodeReadinessRuleCRDYAML = []byte(`---
